package com.kinduberre.redissearchdemo;
...
public class RedisSearchDemoApplication {
    ...
    CommandLineRunner loadData() {
        return args -> {
            ...
            Post[] posts = mapper.readValue(data, Post[].class);
            ...
            jedis.ftCreate("post-idx", IndexOptions.defaultOptions().setDefinition(indexDefinition),
                    schema);
        };
    }
}
